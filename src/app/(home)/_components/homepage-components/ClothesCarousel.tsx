...
export const ClothesCarousel = () => {
  const { data: products, isFetched } = useQuery({
    queryFn: async () => getClothes(0, 6993, 15, 'freshness'),
  ...
  return (
    <div className="slider-container group relative max-w-[1500px] mx-auto w-full ">
      <Slider {...settings} ref={sliderRef} className="main-container w-full">
        {isFetched &&
